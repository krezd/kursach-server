...
public class UserController {
    ...
    public ResponseEntity<?> updateUserByWorker(HttpServletRequest request, @RequestBody UpdateUserRequest updateUserRequest){
        if (!(Objects.equals(updateUserRequest.getNewPassword(), updateUserRequest.getConfirmNewPassword()))) {
    ...
    public ResponseEntity<?> updateUserByAdmin(@RequestBody UpdateUserByAdminRequest updateUserByAdminRequest){
        return userService.updateUserByAdmin(updateUserByAdminRequest);
    }
